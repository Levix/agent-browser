...
- URL matching uses substring `contains` (not wildcard or regex).
- If multiple responses match, the first observed match is returned.
...
# If nothing matches, inspect captured requests first
